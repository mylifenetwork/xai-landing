          ...
          <div className="flex flex-wrap -mx-4">
            <div className="w-full px-4">
              <div className="mx-auto max-w-[530px] text-center">
                {browserName !== 'Safari' ? (
                      <video height={450} width={800} controls controlsList="nofullscreen nodownload">
                          <source src="public/images/rthk/RTHK-ver2-wo-fc.mp4" type="video/mp4" />
                      </video>
                  ) : (
                      <div> Please use Chrome to view this demo. </div>
                  )}
                <Link
                  href="/"
